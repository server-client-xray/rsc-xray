...
function Page() {
    ...
    <section className="v-hero" id="hero">
      ...
      <div className="container v-inner">
        ...
        <div className="v-actions">
          ...
          <button className="button secondary v-btn" onClick={handleCopy} type="button">
            {copied ? (
        ...
        <div className="v-shell" id="install">
          <div className="v-shell-head">
            ...
            <button className="v-copy" onClick={handleCopy} type="button">
  ...
  return <PageShell hero={hero} rootClass="v2 page" />;
}
